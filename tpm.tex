...
Une fois les schémas de la base de données mis en place il sera temps de peupler ces dernières.
La récupération d'informations et l'insertion de ces dernières dans la base de données joueront un rôle crucial par rapport aux résultats de la phase de test.
